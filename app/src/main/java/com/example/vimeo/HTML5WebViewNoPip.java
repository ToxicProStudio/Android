...
import com.lolipop.hdhotvideo.R;
...
public class HTML5WebViewNoPip extends WebView {
	...
	private void init(Context context) {
		...
		mBrowserFrameLayout = (FrameLayout) LayoutInflater.from(a).inflate(R.layout.vimeo_custom_screen_no_pip, null);
	...
	public HTML5WebViewNoPip(Context context) {
		super(context);
		init(context);
	}

	public HTML5WebViewNoPip(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public HTML5WebViewNoPip(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class MyWebChromeClient extends WebChromeClient {
		...
		public void onShowCustomView(View view, CustomViewCallback callback)
		{
	        ...
	        HTML5WebViewNoPip.this.setVisibility(View.GONE);
	        Log.d(TAG, "HTML5WebView child count: "+ HTML5WebViewNoPip.this.getChildCount());
		...
		public void onHideCustomView() {
			...
			HTML5WebViewNoPip.this.setVisibility(View.VISIBLE);
